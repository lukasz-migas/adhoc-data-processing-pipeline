function f_saving_anova( filesToProcess, main_mask_list, norm_list, anova_masks, anova_effect_1_name, anova_effect_1, anova_effect_2_name, anova_effect_2 )
...
for main_mask = main_mask_list
    ...
    for norm_type = norm_list
        ...
        anova_analysis_table = [ ...
            [ 'p value for ' anova_effect_1_name ' effect (mean))' ], [ 'p value for ' anova_effect_2_name ' effect (mean))' ], anova_masks, ...
            [ 'p value for ' anova_effect_1_name ' effect (median))' ], [ 'p value for ' anova_effect_2_name ' effect (median))' ] anova_masks, ...
        ...
        for mzi = 1:size(datacube.spectralChannels,1)
            ...
            if sum(~isnan(mean_d))>0
                ...
                [ mean_p, ~, ~, ~ ] = anovan(mean_d, {anova_effect_1, anova_effect_2}, 'display','off');
                [ median_p, ~, ~, ~ ] = anovan(median_d, {anova_effect_1, anova_effect_2}, 'display','off');
