function f_data_4_sup_class_ca( filesToProcess, main_mask_list, smaller_masks_list, project_id, dataset_name, txt_or_mat )

switch project_id
    
    case "beatson"
        
        classes = f_beatson_classes_4_sup_class(dataset_name);
        
    case "icr"
        
        classes = f_icr_classes_4_sup_class(dataset_name);
