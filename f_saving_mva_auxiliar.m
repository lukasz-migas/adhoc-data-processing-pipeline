function f_saving_mva_auxiliar( mva_type, mva_path, dataset_name, main_mask, norm_type, numComponents, numLoadings, datacube_cell, outputs_xy_pairs, peak_assignments_path, spectra_details_path )
