function [ Density, MinDist, NumIns, SortDensity, nneigh, DisMatrix, dc  ] = FDC_toDecisionGraph( data,distance,perct,cut_off)
% LC-FDC up to the step of creating the decision graph
%the outputs ofthis function can then be taken for the function
