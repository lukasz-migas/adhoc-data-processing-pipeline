...
file_index = 3; % Index of which one of the files in filesToProcess would you like to work on?                      

disp(filesToProcess(file_index).name);


output_mask = "SI-B1-20-KRAS-1";    % Name for the new mask.
...
study = "Beatson"; 
dataset_name = "negative DESI 2018 03 & 2019 06 & 07";
background = 0;
