...
load('\\datasvr1\MALDI_AMBIENT_DATA\2020_Scripts for Data Processing\Git Repository (March 2020)\databases-mat-files\complete_hmdb_info_strings.mat')
...
for file_index = 1:length(filesToProcess)
    ...
    for mask_type = mask_list
        ...
        % Loading peak details (common for all files to be combined)
        ...
        [~, peak_mz_indexes] = ismembertol(peakDetails(:,2),totalSpectrum_mzvalues,1e-10);
