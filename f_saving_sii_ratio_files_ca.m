...
for ratio_i = double(unique(sample_info_1(:,end)))'
    
    for peak_1_i = 1:size(peak_details_1,1)
        for peak_2_i = 1:size(peak_details_2,1)
            
            if (peak_details_1(peak_1_i,end)==ratio_i) && (peak_details_2(peak_2_i,end)==ratio_i)
                ...
                window_centre = str2double(sample_info_2(sample_info_indexes_1(peak_2_i),4));
