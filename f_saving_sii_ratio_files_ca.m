...
for peak_1_i = 1:size(peak_details_1,1)
    
    sample_info_i_1 = find(sample_info_1,'first')
    
    for peak_2_i = 1:size(peak_details_2,1)
        
        for sample_info_i = sample_info_i
            ...
            name_adduct_2plot_1_1 = sample_info_1(sample_info_i,1);
            name_adduct_2plot_1_2 = sample_info_2(sample_info_i,1);
            name_adduct_2plot_r = repmat(" / ",size(name_adduct_2plot_1_1,1),1);
            name_adduct_2plot_2_1 = sample_info_1(sample_info_i,3);
            name_adduct_2plot_2_2 = sample_info_2(sample_info_i,3);
            
            name_adduct_2plot   = cat(2, name_adduct_2plot_1_1, name_adduct_2plot_2_1, name_adduct_2plot_r, name_adduct_2plot_1_2, name_adduct_2plot_2_2, name_adduct_2plot_3);
            ...
            if ~strcmp(sample_info(sample_info_i,7),'not assigned')
                ...
                patch_x = [ peak_details(peak_1_i,1) peak_details(peak_1_i,3) peak_details(peak_1_i,3) peak_details(peak_1_i,1) ];
            ...
            if isitloadings
                figname_char = [ char(num2str(peak_1_i)) '_' name(1:min(68,length(name)))' '.fig' ];
                tifname_char = [ char(num2str(peak_1_i)) '_' name(1:min(68,length(name)))' '.png' ];
            else
