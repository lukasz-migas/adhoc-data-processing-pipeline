function [ modality, polarity, adducts_list, ...
    mva_list, numPeaks4mva, ...
    numComponents_array, numLoadings_array, ...
    mva_molecules_lists_csv_list, mva_molecules_lists_label_list, mva_max_ppm, ...
    pa_molecules_lists_csv_list, pa_molecules_lists_label_list, pa_max_ppm, ...
    fig_ppm, ...
    ...
    switch inputs_info_reshaped(i)
        ...
        case "Highest intensity"
            if strcmpi(inputs_info_reshaped(i+2),"yes")
                ...
                % mva_molecules_lists_label_list  = [ mva_molecules_lists_label_list, [ num2str(numPeaks4mva) "_highest_peaks"] ];
