...
for file_index = 1:length(filesToProcess)
    ...
    for main_mask = main_mask_list
        ...
        load([ peak_assignments_path filesToProcess(file_index).name(1,1:end-6) filesep char(main_mask) filesep 'relevant_lists_sample_info' ])
        load([ peak_assignments_path filesToProcess(file_index).name(1,1:end-6) filesep char(main_mask) filesep 'hmdb_sample_info' ])
        ...
        f_saving_sii_sample_info(filesToProcess(file_index), main_mask, norm_list, sample_info, mask_on )
